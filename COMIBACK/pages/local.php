    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <a class="navbar-brand" href="../comiback.php">ComiBACK</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="ventas.php">GESTION DE VENTAS</a></li>
                </ul>
...
<form class="col-4 p-3" method="POST" action="../controlador/agregarLocal.php">
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" name="Delivery">
            <div id="emailHelp" class="form-text">Delivery.</div>
        </div>
